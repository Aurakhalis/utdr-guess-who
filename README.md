...
Once you've decided on the characters, get a `.png` image for each of them (the background should ideally be transparent or black, but no big problem if it isn't). Try not to make all the images simple face-on poses - more varied and dynamic poses will help make the game more interesting, by allowing questions like "Are you sitting down in your image?"
